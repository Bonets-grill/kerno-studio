...
<nav class="bottom-nav">
  ...
  <button onclick="showSection('rooms')"><span class="bnav-icon">◎</span>Habitaciones</button>
  <button onclick="showSection('reservations')"><span class="bnav-icon">☰</span>Reservas</button>
  <button onclick="showSection('calendar')"><span class="bnav-icon">▤</span>Calendario</button>
  <button onclick="showSection('guests')"><span class="bnav-icon">⊞</span>Hu\u00e9spedes</button>
